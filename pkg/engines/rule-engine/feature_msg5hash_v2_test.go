		...
		},
		{
			...
			req: &openai.ChatCompletionRequest{
				...
				Messages: []*openai.Message{
					{
						Role:    "system",
						Content: openai.MessageContentString("系统消息_123456789_123456789_123456789_123456789_123456789_123456789_123456789_123456789_123456789"),
					},
					{
						Role:    "_input",
						Content: openai.MessageContentString("一23四五6七89十1二三45六7八九"),
		...
		},
		{
			...
			req: &openai.ChatCompletionRequest{
				...
				Messages: []*openai.Message{
					{
						Role:    "system",
						Content: openai.MessageContentString("系统消息_123456789_123456789_123456789_123456789_123456789_123456789_123456789_123456789_123456789_DIFF"),
					},
					{
						Role:    "_input",
						Content: openai.MessageContentString("一23四五6七89十1二三45六7八九"),
		...
		},
		{
			...
			req: anthropic.ClaudeMessagesRequest{
				...
				System: anthropic.SystemBlocks{
					{
						Type: "text",
						Text: "系统消息_123456789_123456789_123456789_123456789_123456789_123456789_123456789_123456789_123456789",
					},
				},
				Messages: []*anthropic.MessageParam{
					{Role: "user", Content: anthropic.MessageContentString("一23四五6七89十1二三45六7八九")},
		...
		},
		{
			...
			req: anthropic.ClaudeMessagesRequest{
				...
				System: anthropic.SystemBlocks{
					{
						Type: "text",
						Text: "系统消息_123456789_123456789_123456789_123456789_123456789_123456789_123456789_123456789_123456789_DIFF",
					},
				},
				Messages: []*anthropic.MessageParam{
					{Role: "user", Content: anthropic.MessageContentString("一23四五6七89十1二三45六7八九")},
